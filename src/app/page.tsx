      ...
      <nav style={{
        ...
        <div className="nav-inner" style={{
          ...
          <Link href="/" style={{ textDecoration: "none", display: "flex", alignItems: "baseline", letterSpacing: 0 }}>
            <span style={{ color: "#99E1D9", fontWeight: 700, fontSize: 21, fontFamily: "var(--font-geist-sans)", letterSpacing: 0, WebkitTextStroke: "0.5px rgba(255,255,255,0.4)" }}>Byzant</span>
          </Link>
      ...
      <footer style={{
        ...
        <div style={{
          ...
          <Link href="/" style={{ textDecoration: "none", display: "flex", alignItems: "baseline" }}>
            <span style={{ color: "#99E1D9", fontWeight: 700, fontSize: 18, fontFamily: "var(--font-geist-sans)", letterSpacing: 0, WebkitTextStroke: "0.5px rgba(255,255,255,0.4)" }}>Byzant</span>
          </Link>
